...
function OneUserPage() {
  ...
  return (
    <div className="w-full p-3 mt-10 max-md:w-full">
      <ToastContainer />
      <div className="p-4 flex flex-col items-center ">
        {user && (user.id === id) ? <UpdateImage toast={toast} setUp={setUp} oneUser={oneUser} /> : 
          <UserImage oneUser={oneUser}/>
        }
